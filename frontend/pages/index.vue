<template>
  ...
  <div class="flex flex-col items-center justify-center w-full gap-8 mb-8 lg:flex-row">
    ...
    <a :href="data.externalLinks.updates.href" target="_blank">
      <div
        class="flex items-center justify-center text-xl text-center text-white uppercase transition-all duration-300 scale-110 rounded-full h-36 w-96 size-fit custom-title-font hover:scale-125"
