<template>
  <div>
    ...
    <div
      ...
      style="
        ...
        background-image: url('https://unparcoinbiblioteca.netlify.app/images/header_parco_biblioteca_460.jpg');
    ...
    <div class="flex flex-col gap-16 px-8 py-24 md:flex-row md:px-16 md:gap-0">
      <div class="w-full md:w-1/3 md:pr-16">
        <img
          ...
          class="-rotate-12 rounded-tr-[64px] rounded-bl-[64px]"
        />
      </div>
    ...
    <div class="flex flex-col justify-center gap-16 px-6 lg:flex-row md:px-32">
      ...
      <div class="w-full lg:w-1/3">
        <img
          :src="data.why.img"
          alt="Un parco in biblioteca"
          class="rounded-tl-[256px] rounded-tr-[128px] rounded-br-[256px] rounded-bl-[128px]"
        />
      </div>
    </div>
  </div>
  ...
  <div class="flex flex-col items-center justify-center w-full gap-8 mb-8 lg:flex-row">
    ...
    <a :href="data.externalLinks.updates.href" target="_blank">
      <div
        class="flex items-center justify-center h-40 text-xl text-center text-white uppercase transition-all duration-300 scale-110 rounded-full w-96 size-fit custom-title-font hover:scale-125"
  ...
  <div class="flex flex-col">
    <div
      class="px-6 pb-2 text-3xl tracking-tighter uppercase xl:px-32 xl:text-5xl custom-title-font text-biblioteca-blue"
    >
      {{ data.join.title }}
    </div>
    <div class="flex flex-col gap-12 px-6 py-8 text-white xl:px-32 xl:flex-row bg-biblioteca-blue">
      <div class="flex flex-col w-full gap-4 xl:w-2/3">
        <div
          ...
          :key="`join-${index}`"
          class="flex flex-col gap-4 text-start first:xl:text-3xl first:text-2xl first:font-bold"
        >
          <div v-html="how" />
        </div>
      </div>
