...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-GXbuKv-_.mjs";
...
const dependencies = {
  ...
  "@strapi/helper-plugin": "4.25.19",
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.19",
  "@strapi/provider-audit-logs-local": "4.25.19",
  "@strapi/types": "4.25.19",
  "@strapi/typescript-utils": "4.25.19",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.19",
  "@strapi/data-transfer": "4.25.19",
...
const CM = React.lazy(
  () => import("./index-GXbuKv-_.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-U5pzbUga.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-tSs9HYCy.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-1h8lwkCd.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-GXbuKv-_.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-KcPxmWZp.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-vNUWg6Y7.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-ZDEcVJFL.mjs.map
