...
const useWebhooks = require("./useWebhooks-_ihVQATo.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-yt9YV3PW.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-CkNfUaI_.js.map
