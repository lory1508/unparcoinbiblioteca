...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-GXbuKv-_.mjs";
...
import { u as useWebhooks } from "./useWebhooks-aPzB1S1_.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-mVQnHLBG.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Yxk7NS8a.mjs.map
