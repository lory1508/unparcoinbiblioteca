...
const ListView$1 = lazy(() => import("./ListView-yUKOcpoc.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-yUKOcpoc.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-A53BjRx0.mjs.map
