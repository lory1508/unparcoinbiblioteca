...
var path = require("node:path"), chalk = require("chalk"), helpers = require("yargs/helpers"), yargs = require("yargs/yargs"), runtime = require("./runtime.js"), checkRequiredDependencies = require("./checkRequiredDependencies.js"), servers = require("./servers.js"), timing = require("./timing.js");
...
const getCoreURL = () => process.env.SANITY_INTERNAL_ENV === "staging" ? "https://core.sanity.work" : "https://core.sanity.io", getCoreAppURL = ({
  organizationId,
  httpHost = "localhost",
  httpPort = 3333
...
async function startSanityDevServer(args, context) {
  ...
  if (loadInDashboard) {
    ...
    try {
      ...
      output.error("Failed to get organization Id from project Id"), process.exit(1);
    }
  }
  try {
