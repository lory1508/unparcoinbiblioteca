"use strict";
var path = require("node:path"), zlib = require("node:zlib"), tar = require("tar-fs"), buildAction = require("./buildAction.js"), _internal = require("./_internal.js"), storeSchemasAction = require("./storeSchemasAction.js"), schemaApiClient = require("./schemaApiClient.js"), helpers = require("./helpers.js");
...
`);
  ...
  _internal.SCHEMA_STORE_FEATURE_ENABLED ? await storeSchemasAction.default({
