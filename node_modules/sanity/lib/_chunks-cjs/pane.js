...
const DISABLED_REASON_KEY$2 = {
  ...
  const {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), isPublished = displayed?._id && sanity.isPublishedId(displayed?._id), handleConfirm = React.useCallback(() => {
...
const DISABLED_REASON_KEY$1 = {
  ...
  const documentStore = sanity.useDocumentStore(), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), currentUser = sanity.useCurrentUser(), handle = React.useCallback(async () => {
...
const DISABLED_REASON_KEY = {
  ...
  const {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), isDraft = displayed?._id && sanity.isDraftId(displayed?._id), handleCancel = React.useCallback(() => {
    setConfirmDialogOpen(!1), onComplete();
